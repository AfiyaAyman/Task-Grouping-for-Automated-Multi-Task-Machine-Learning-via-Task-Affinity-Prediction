...
def final_model(task_hyperparameters, shared_hyperparameters, task_group_list, data_param_dict_for_specific_task,
    ...
    filepath = f'SavedModels/RS_School_Group_{group_no}_{fold}.h5'
...
if __name__ == '__main__':
    ...
    Prev_Groups = {}
    for count in range(len(partition_data)):
        ...
        if len(Total_Loss)%10 == 0:
            ...
            temp_res.to_csv(f'../Groupwise_Affinity/{datasetName}_Random_Search_{len(Total_Loss)}_run_{run}.csv', index=False)
